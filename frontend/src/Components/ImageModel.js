...
const ImageModel = ({ imgSrc, imgArr, swiperRef }) => {
    ...
    return (
        <div className="h-screen w-full scale-0 opacity-0 fixed top-0 left-0 bg-primary-850/50 backdrop-blur-lg py-5 flex items-center justify-center transition-all duration-300 z-50" id="imageModelContainer">
            <div
