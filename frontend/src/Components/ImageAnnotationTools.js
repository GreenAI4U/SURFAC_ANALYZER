...
const ImageAnnotationTools = ({ tempShape, setTempShape, mode, setMode, magicPoints, setMagicPoints }) => {
    return (
        <div className="absolute flex flex-col py-2 items-center justify-between h-96 w-12 rounded-lg shadow-lg top-1/2 -translate-y-1/2 right-5 bg-primary-850 z-40">
            <div className="flex flex-col gap-1 border-b-2 pb-1 border-primary-200/50">
                ...
                >
                    <div className="absolute -left-[500%] right-[150%] bg-primary-850 p-1 px-2 text-white rounded-lg scale-0 opacity-0 group-hover:scale-100 origin-right group-hover:opacity-100 translate-x-20 group-hover:translate-x-0 transition-all duration-300 text-left">
            ...
            <div className="flex flex-col gap-1 border-b-2 pb-1 border-primary-200/50">
                ...
                >
                    <div className="absolute -left-[500%] right-[150%] p-1 px-2 text-white bg-primary-850 rounded-lg scale-0 opacity-0 group-hover:scale-100 origin-right group-hover:opacity-100 translate-x-20 group-hover:translate-x-0 transition-all duration-300 text-left ">
                        <p className="text-xl font-mono">
