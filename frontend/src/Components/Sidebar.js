...
const Sidebar = () => {
    ...
    return (
        <div className="w-[20vw] h-full border-2 border-primary-800 rounded-xl overflow-hidden">
            <div className="w-full bg-primary-900 py-2 border-b-2 border-primary-800">
                <p className="text-center font-bold text-primary-500">Nodes</p>
            </div>
            <div className="relative border-b border-primary-800">
                <input type="text" name="nodeSearch" id="nodeSearch" placeholder="Search..." className="w-full p-2 pl-9 outline-none focus:outline-none bg-primary-850 text-white" />
                            ...
                            <div className="bg-primary-900 max-h-[48px] overflow-hidden transition-all duration-300" id={"dropdownContainer-" + index}>
                                ...
                                <div className="px-2">
                                    {item.subItems.map((subItem, subIndex) => (
                                        <div key={subIndex} onDragStart={(event) => onDragStart(event, subItem.subNodeType)} draggable className={"pipeJoins flex items-center gap-2 p-2 px-3 bg-primary-850 text-white rounded-xl border-l-[5px] border-" + item.borderColor + "-600 mb-3"}>
                                            {subItem.subSVG}
                                            <p className="text-white">{subItem.subName}</p>
                                        </div>
                                    ))}
                                    {/* <div onDragStart={(event) => onDragStart(event, "InputDataset")} draggable className="flex items-center gap-2 p-2 px-3 bg-primary-850 text-white rounded-xl border-l-[5px] border-red-600 mb-3">
									<svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-tag" viewBox="0 0 16 16">
										<path d="M6 4.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-1 0a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0z" />
										<path d="M2 1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 1 6.586V2a1 1 0 0 1 1-1zm0 5.586 7 7L13.586 9l-7-7H2v4.586z" />
									</svg>
								...
								<div onDragStart={(event) => onDragStart(event, "SplitDataset")} draggable className="flex items-center gap-2 p-2 px-3 bg-primary-850 text-white rounded-xl border-l-[5px] border-red-600 mb-3">
									<svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} fill="currentColor" className="bi bi-file-earmark-zip" viewBox="0 0 16 16">
										<path d="M5 7.5a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v.938l.4 1.599a1 1 0 0 1-.416 1.074l-.93.62a1 1 0 0 1-1.11 0l-.929-.62a1 1 0 0 1-.415-1.074L5 8.438V7.5zm2 0H6v.938a1 1 0 0 1-.03.243l-.4 1.598.93.62.929-.62-.4-1.598A1 1 0 0 1 7 8.438V7.5z" />
										<path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1h-2v1h-1v1h1v1h-1v1h1v1H6V5H5V4h1V3H5V2h1V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z" />
									</svg>
