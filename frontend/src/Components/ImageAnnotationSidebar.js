...
const ImageAnnotationSidebar = ({ setLabels }) => {
    ...
    return (
        <div className="w-[20%] bg-primary-850 rounded-lg inner-shadow p-3 relative">
            <div id="cvatLink" className="absolute -right-5 top-2 h-fit bg-primary-950 border border-gray-100/25 p-1 gap-1 flex flex-col rounded-lg z-[70] translate-x-full cursor-pointer scale-0 transition-all ">
                ...
                <a href="https://www.cvat.ai/" target="_blank">
                    <div className="">
                        ...
                        <button className="h-10 rounded shadow-xl overflow-hidden bg-primary-850 text-white w-20 flex flex-nowrap justify-center items-center gap-2">
                            Train
                                ...
                                <div key={index} className="text-white overflow-hidden w-full">
                                    <div className="relative group">
                                        <button
                                            ...
                                            className="absolute h-7 w-7 scale-0 -translate-x-full group-hover:translate-x-0 group-hover:scale-100 bg-transparent hover:bg-primary-200 top-2 right-2 rounded border-2 border-transparent hover:border-primary-800 flex items-center justify-center transition-all duration-300"
                                        >
