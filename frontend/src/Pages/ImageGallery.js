    ...
    return (
        <div className="mt-4 w-[80%] text-white mx-auto">
            ...
            <div className="grid grid-cols-1 gap-4 gap-y-1 ">
                <div className="grid grid-cols-2 gap-4 border border-primary-800 rounded-lg p-2">
                    ...
                    <label className="block text-sm">
                        ...
                        <span className="relative mt-1.5 flex">
                            <select required id="dataset" name="dataset" className="form-input outline-none peer w-full rounded-lg border border-slate-300 bg-white text-black px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent">
                                <option selected value="">
                                    --Select Dataset--
                                </option>
                ...
                <div
                    ...
                    className="bg-primary-850 h-10 my-3 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3"
                >
                    <p className="font-mono font-meduim">Load Dataset </p>
                </div>
            </div>
            <div className="h-fit mb-5 border border-primary-800 rounded-lg p-2">
                <label className="block text-sm">
                    ...
                    <div>
                        <div className="flex items-center justify-between w-full mt-2">
                            ...
                            <label className="block text-sm">
                                <span className="relative flex">{/* <select id="Annotator" name="Annotator" className="form-input outline-none peer w-72 rounded-lg border bg-white border-slate-300 bg-transparent px-3 py-2 text-sm text-black hover:border-primary-700 focus:border-primary ">
                                        <option selected value="">
                                            --Select Annotator--
                                        </option>
