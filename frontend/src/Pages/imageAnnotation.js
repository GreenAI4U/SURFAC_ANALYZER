    ...
    return (
        <div className="bg-primary-950 p-3 w-full h-[calc(100vh-7rem)] flex flex-nowrap gap-3 overflow-hidden">
            ...
            <div id="imageAnnotationMain" className="w-[80%] h-full bg-primary-900 rounded-lg inner-shadow overflow-hidden cursor-crosshair">
                <div className="absolute top-0 left-0 w-full bg-primary-850/50"></div>
                <div
                    id="imageContainer"
                    onMouseMove={(event) => {
                ...
                >
                    ...
                    <div id="menu" className="scale-y-0 h-fit w-fit py-1 px-2 bg-primary-850 shadow-lg text-white absolute rounded-lg transition-all">
                        {mode === "magic" ? (
                    ...
                    <div id="loader" className="absolute h-full w-full bg-primary-850/70 z-40  backdrop-blur-lg animate-pulse scale-0 transition-all">
                        <svg
