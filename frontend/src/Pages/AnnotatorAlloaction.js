                    ...
                    <div className="grid grid-cols-2 gap-4 gap-y-1 relative mb-5 overflow-hidden">
                        <div className="grid grid-rows-3 gap-4 gap-y-1 h-64 border border-primary-800 rounded-lg p-2">
                            ...
                            <div
                                ...
                                className="bg-primary-850 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3"
                            >
                                <p className="font-mono font-meduim">Click Here To Refresh Project List</p>
                            </div>
                        </div>

                        <div className="grid grid-rows-3 gap-4 gap-y-1 h-fit border border-primary-800 rounded-lg p-2">
                            <div className="grid grid-cols-2 gap-4 mb-3">
                                <div className="block text-sm">
                                    <span>Annotator</span>
                                    <span className="relative mt-1.5 flex">
                                        <select id="Annotator" name="Annotator" className="form-input outline-none peer w-full rounded-lg border bg-white border-slate-300 bg-transparent px-3 py-2 text-black hover:border-primary-700 focus:border-primary ">
                                            <option selected value="">
                                                --Select Annotator--
                                            </option>
