...
const TrainForm = () => {
    ...
    return (
        <div className="min-h-screen w-[calc(100%-2rem)] mx-auto h-full mb-5">
            <div className="w-full h-full text-black mx-auto mt-5 backdrop-blur-xl rounded-none lg:rounded-xl overflow-hidden">
                <div className="mt-4 ">
                    <div className="grid grid-cols-2 gap-4 gap-y-1 relative mb-5 overflow-hidden">
                        <div className="grid grid-rows-3 gap-4 gap-y-1 h-64 border border-primary-800 rounded-lg p-2">
                            ...
                            <label className="block text-sm">
                                ...
                                <span className="relative mt-1.5 flex">
                                    <select
                                        ...
                                        id="dataset"
                                        name="dataset"
                                        className="form-input outline-none peer w-full rounded-lg border border-slate-300 bg-white text-black px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    >
                                        <option selected value="">
                                            --Select Dataset--
                                        </option>
                            ...
                            <div
                                ...
                                className="bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-700 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3"
                            >
                                <p className="font-mono font-meduim text-white">Click Here To Refresh Project List</p>
                            </div>
                        </div>
                        <div className="flex flex-col justify-between gap-3 gap-y-1 h-64 border border-primary-800 rounded-lg p-2">
                            <div id="resume" className="items-center justify-end gap-3 hidden">
                                ...
                                <label className="relative w-10 h-5">
                                    ...
                                    />
                                    <span className="absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-primary-850 transition-all duration-300 rounded-full before:absolute before:h-3 before:w-3 before:bg-white before:content-[''] before:left-[4px] before:top-1/2 before:-translate-y-1/2 before:rounded-full before:transition-all before:duration-300 peer-checked:bg-green-500 peer-checked:before:translate-x-[20px]" />
                                </label>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="w-full">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-lg px-3 py-1.5 mt-1.5 border border-gray-300 hover:border-primary-700 focus:outline-none bg-white text-black placeholder:text-black"
                                    />
                                </div>
                                <label className="block text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-3">
                                <div className="w-full my-3">
                                    <div className="flex items-center justify-start gap-1 mb-2 text-xs font-mono">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-full shadow-inner shadow-gray-300"
                                    />
                                </div>
                                <div className="w-full my-3">
                                    <div className="flex items-center justify-start gap-1 mb-2 text-xs font-mono">
                            ...
                            <div
                                ...
                                className="bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-700 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3 h-10 mt-3"
                            >
                                <p className="font-mono font-meduim text-white">Train</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full h-4 bg-primary-850 rounded-full mb-3 relative shadow-inner hidden" id="progressBar">
                    ...
                    <div className="h-fit mb-5 border border-primary-800 rounded-lg p-2" ref={wrapperRef}></div>
                </div>
            </div>
        </div>
    );
