            ...
            <div className="p-[2px] w-full h-full text-black mx-auto mt-5 backdrop-blur-xl rounded-none lg:rounded-xl overflow-hidden">
                <div className="mt-4 grid grid-cols-2 gap-6">
                    <div className="grid grid-cols-2 gap-4 gap-y-2">
                        <div className="h-64 border border-primary-700 rounded-lg p-2 overflow-hidden">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="w-full h-fit mb-3">
                                    <p>Fabric Name</p>
                                    <input id="fabricName" name="fabricName" type="text" placeholder="Enter fabric name..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none" />
                                </div>
                                <div className="w-full h-fit mb-3">
                                    <p>Fabric Type</p>
                                    <div className="relative mt-1.5 flex">
                                        <select id="fabricType" name="fabricType" className="form-input outline-none peer w-full rounded-lg border bg-white border-slate-300 bg-transparent px-3 py-1.5 text-black hover:border-primary-700 focus:border-primary ">
                            ...
                            <div className="w-full mb-3">
                                <p>Fabric Details</p>
                                <textarea id="fabricDetails" name="fabricDetails" rows={1} placeholder="Enter fabric details..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none resize-none" />
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                <div className="w-full h-fit mb-3">
                                    <p>Color</p>
                                    <input id="fabricColor" name="fabricColor" type="text" placeholder="Enter color..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none" />
                                </div>
                                <div className="w-full h-fit mb-3">
                                    <p>GSM</p>
                                    <input id="fabricGSM" name="fabricGSM" type="text" placeholder="Enter GSM..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none" />
                                </div>
                                <div className="w-full h-fit mb-3">
                                    <p>Material</p>
                                    <input id="fabricMaterial" name="fabricMaterial" type="text" placeholder="Enter material..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none" />
                                </div>
                            </div>
                        </div>
                        <div id="labelContainer" className="h-64 border border-primary-700 rounded-lg  overflow-y-scroll">
                            <div className="flex flex-nowrap justify-between sticky top-0 z-40 bg-primary-600 p-2">
                                <p className="text-white">Labels</p>
                                <div className="flex flex-nowrap ">
                                    <svg
                                        onClick={() => {
                                            ...
                                            newInput.setAttribute("class", "w-full rounded-lg px-3 py-1.5 border border-gray-300 hover:border-primary-700 shadow-lg shadow-primary-200/30 bg-white text-black placeholder:text-black outline-none focus:outline-none");
                                        ...
                                        viewBox="0 0 48 48"
                                    >
                                        <circle fill="#4CAF53" stroke="#000" cx={24} cy={24} r={21} />
                                        <g fill="#fff">
                                    ...
                                    <svg
                                        ...
                                        viewBox="0 0 48 48"
                                    >
                                        <circle fill="#ff0000" stroke="#000" cx={24} cy={24} r={21} />
                                        <g fill="#fff">
                                            <path d="M14 21h20v6H14z" />
                                        </g>
                                    </svg>
                            ...
                            <div className="w-full px-2 group h-fit flex flex-nowrap gap-2 mb-3 mt-1.5 items-center justify-between">
                                <input id="label1" name="label1" type="text" placeholder="Enter label 1 Name..." className="w-full rounded-lg px-3 py-1.5 border border-gray-300 hover:border-primary-700 shadow-lg shadow-primary-200/30  bg-white text-black placeholder:text-black outline-none focus:outline-none" />
                        ...
                        <div className="h-64 border border-primary-700 rounded-lg p-2">
                            <p>Images</p>
                            <div className="h-28 w-full text-white border border-primary-700 mt-1.5 rounded-lg bg-gradient-to-tr hover:bg-gradient-to-bl from-primary-500 to-primary-600 backdrop-blur-xl inner-shadow relative flex flex-col items-center justify-center">
                                <input
                                    onChange={() => {
                        ...
                        <div className="h-64 border border-primary-700 rounded-lg p-2">
                            <p>Dataset</p>
                            <div className="h-52 w-full text-white border border-primary-700 mt-1.5 rounded-lg bg-gradient-to-tr hover:bg-gradient-to-bl from-primary-500 to-primary-600 backdrop-blur-xl inner-shadow relative flex flex-col items-center justify-center">
                                <input
                                    type="file"
                                    name="datasetInput"
                                    id="datasetInput"
                        ...
                        <div
                            ...
                            className="w-full col-span-2 bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-700 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 rounded-lg text-center p-2 cursor-pointer"
                        >
                            <p className="font-mono font-medium text-white">Register Fabric</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                        <div className="h-fit border border-primary-700 rounded-lg p-2 col-span-2">
                            <div className="text-sm grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <p>Dataset</p>
                                    <span className="relative mt-1.5 flex">
                                        <select id="dataset" name="dataset" className="form-input outline-none peer w-full rounded-lg border bg-white border-slate-300 bg-transparent px-3 py-2 pl-9 text-black hover:border-primary-700 focus:border-primary ">
                                            <option selected value="">
                                                --Select Dataset--
                                            </option>
                            ...
                            <div className="w-full mt-2">
                                <p>Fabric Details</p>
                                <textarea id="fabricDetails" name="fabricDetails" value={fabricDetails} rows={3} placeholder="Enter fabric details..." className="w-full rounded-lg px-3 py-1.5 mt-1.5 bg-white shadow-xl shadow-primary-100/50 border border-gray-300 hover:border-primary-700 text-black placeholder:text-black outline-none focus:outline-none" />
                            </div>
                            <div className="bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-700 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3 py-2 mt-1">
                                <p className="font-mono font-meduim text-white">Click Here To Refresh Fabric List</p>
                            </div>
                        </div>
                        <div className="h-64 border border-primary-700 rounded-lg p-2">
                            <p>Images</p>
                        ...
                        <div className="h-64 border border-primary-700 rounded-lg p-2 relative overflow-hidden">
                            <p>Dataset</p>
                            <div
                                onClick={(event) => {
                                    event.target.classList.add("animate-pulse");
                                ...
                                className="absolute top-0 right-0  bg-gradient-to-tr hover:bg-gradient-to-bl from-green-500 to-green-600 px-3  rounded-bl-lg cursor-pointer hover:bg-green-600 transition-all duration-300"
                            >
