        ...
        <div className="min-h-screen w-[calc(100%-2rem)] mx-auto h-full mb-5">
            <div className="w-full h-full text-black mx-auto mt-5 pb-5 backdrop-blur-xl rounded-none lg:rounded-xl overflow-hidden">
                <div className="mt-4 flex gap-3 items-center justify-start">
                    <div className="flex gap-4 gap-y-1 w-fit h-fit border border-primary-700 rounded-lg p-2 overflow-hidden">
                        <div className="block text-sm" title="Select a Project">
                            ...
                            <div className="relative mt-1.5 flex gap-2">
                                ...
                                <div
                                    ...
                                    className="bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-600 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 w-10 h-10 p-2 rounded-lg flex items-center justify-center cursor-pointer hover:bg-primary-850/50 transition-all duration-3"
                                >
                    ...
                    <div
                        ...
                        className="bg-gradient-to-br  from-primary-500 via-primary-700 to-primary-700 hover:from-primary-500 hover:via-primary-600 hover:to-primary-600 text-white font-mono font-medium flex gap-3 items-center justify-between px-5 w-fit h-16 py-3 rounded-lg text-center cursor-pointer hover:bg-primary-850/50 transition-all duration-300"
                    >
                        {toggleStart ? (
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-3 gap-5 mt-10`}>
                    {cameraList.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="relative border border-primary-700 rounded-lg p-4 w-full h-fit">
                                <p className="bg-primary-700 rounded-full text-white absolute top-0 left-4 -translate-y-3 px-5">
                                ...
                                <img
                                    ...
                                    src={process.env.REACT_APP_SERVER + "/api/realtimePrediction/?cameraIndex=" + cameraData[0] + "&project=" + document.getElementById("project").value + "&modelName=" + document.getElementById("model").value + "&seed=" + Math.random() * 1000}
                                    onError={(event) => {
