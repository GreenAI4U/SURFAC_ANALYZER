...
const ProjectDetails = () => {
    ...
    return (
        <div className="h-full mb-5 w-[calc(100%-2rem)] mx-auto">
            <div className="px-1 w-full h-full text-black mx-auto mt-5 backdrop-blur-xl rounded-none lg:rounded-xl overflow-hidden">
                <div className="flex">
                    <a href="/" className="flex items-center gap-2 bg-gradient-to-tr from-green-700 to-green-500 p-2 text-white rounded-full">
                ...
                <div className="grid grid-cols-2 gap-5">
                    <div className="flex flex-col gap-5 shadow-xl shadow-primary-100/50 border border-primary-700 bg-primary-900 p-2 px-4 rounded-xl overflow-hidden my-5 mb-8">
                        <div className="w-full border-b border-primary-700 pb-6">
                            <div className="flex items-center justify-between">
                                <p className="text-primary-600 text-2xl font-semibold">{projectDetails?.fabricName} ({projectDetails?.fabricType})</p>
                            </div>
                            <div className="my-5">
                                <p className="text-black/50 font-semibold">Fabric Details</p>
                            ...
                            <div className={"flex justify-between " + (projectDetails?.labels?.length > 0 ? "my-5" : "mt-5")}>
                                <div>
                                    <p className="text-black/50 font-semibold">Color</p>
                                    <p className="text-lg capitalize">{projectDetails?.color}</p>
                                </div>
                                <div>
                                    <p className="text-black/50 font-semibold">GSM</p>
                                    <p className="text-lg capitalize">{projectDetails?.GSM}</p>
                                </div>
                                <div>
                                    <p className="text-black/50 font-semibold">Material</p>
                                    <p className="text-lg capitalize">{projectDetails?.material}</p>
                                </div>
                            </div>
                            {projectDetails?.labels?.length > 0 && (
                                <div className="mt-5">
                                    <p className="text-black/50 font-semibold">Labels</p>
                        ...
                        <div className="w-full">
                            <p className="text-black/50 font-semibold mb-2">Images</p>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-5 mt-5">
                            <div className="relative">
                                ...
                                />
                                <svg viewBox="0 0 16 16" className="w-4 h-5 text-black absolute top-1/2 left-2 -translate-y-1/2">
                                    ...
                                    if (item.datasetName.toLowerCase().includes(searchQuery.toLowerCase())) {
                                        return (
                                            <div
                                                ...
                                                className="border bg-primary-900 border-primary-700 rounded-lg overflow-hidden flex items-center justify-between w-full p-3 hover:border-primary-700 cursor-pointer  hover:bg-gradient-to-tr hover:from-primary-100 transition-all"
                                            >
                                                <div className="flex flex-nowrap items-start justify-center gap-4">
                                                    <img
                                                        ...
                                                        className="h-32 w-auto aspect-square border-b-2 border-primary-700 object-cover rounded-md"
                                                    />
                                                    <div className="grid grid-cols-2 gap-5">
                                                        <p className="text-black/50 font-normal">
                                                            Name : <span className="font-semibold truncate text-black">{item.datasetName}</span>
                                                        </p>
                                                        <p className="text-black/50 font-normal">
                                                            Train Images : <span className="text-black font-semibold">{item.trainCount}</span>
                                                        </p>
                                                        <p className="text-black/50 font-normal">
                                                            Test Images : <span className="text-black font-semibold">{item.testCount}</span>
                                                        </p>
                                                        <p className="text-black/50 font-normal">
                                                            Valid Images : <span className="text-black font-semibold">{item.validCount}</span>
                                                        </p>
                                                    </div>
                                                    <button
                                                        onClick={(event) => {
                                                        ...
                                                        className="bg-gradient-to-tr from-green-700 to-green-500 rounded-lg px-4 py-1 text-white hover:bg-primary-600 transition-all"
                                                    >
                                                        Quick Train
                                                    </button>
                                                </div>
